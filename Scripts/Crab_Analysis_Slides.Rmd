...
## Project Goals 
1. Determine the correlation between burrow shape and depth, and the burrow temperature and humidity.
Load data from [Ghost Crab Burrow Morphology and Distribution](https://doi.org/10.6084/m9.figshare.6895109) 
...
```{r, echo=FALSE, out.width="90%", fig.cap="Ghost Crab Habitat"}
